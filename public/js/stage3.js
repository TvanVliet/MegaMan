...
Stage3.prototype = {
    create: function () {
        ...
        //images/sprites/text
        background3 = this.background3 = this.game.add.sprite(0, 0, 'bgstage3');
        bmpText = this.add.bitmapText(200, 20, 'alien', 'Stage 3', 32);
        ...
        ebullets.createMultiple(50, 'bal');
        ...
        this.game.time.events.repeat(Phaser.Timer.SECOND * 1, 6, this.createEnemy, this);
    },
    ...
    update: function () {
        ...
        if (this.game.time.now > firingTimer) {
            ...
            if (livingEnemies.length > 0) {
                ...
                eShootSound.play();
                firingTimer = this.game.time.now + 1000;
            }
        }
    },
    ...
    collisionHandler: function (bullet, enemy) {
        ...
        if (enemies.countLiving() == 0) {
            ...
            stateText.text = "Stage 3 Completed! \n Bossman is waiting.";
    ...
    createEnemy: function () {
        for (var y = 0; y < 2; y++) {
            for (var x = 0; x < 1; x++) {
                enemy = enemies.create(this.game.world.width, Math.random() * 400, 'greenguy', this.game.rnd.integerInRange(0, this.game.world.width + 10));
                enemy.anchor.setTo(0.5, 0.5);
                enemy.scale.setTo(2.5);
                enemy.body.collideWorldBounds = true;
                enemy.body.gravity.y = 4000;
                enemy.enableBody = true;
                enemy.animations.add('swing', [0, 1, 2, 3, 4, 5, 6, 7], 10, true);
                enemy.play('swing');
            }
        }
    },
